...
public class TempleInListFragment extends Fragment implements AdaptorClickInterface {
    private RecyclerView temple_list_recy;
    private static TempleInListFragment templeInListFragment;
    ...
    public TempleInListFragment() {
    }

    public static TempleInListFragment newInstance() {

        if (templeInListFragment == null) {

            templeInListFragment = new TempleInListFragment();
        }
