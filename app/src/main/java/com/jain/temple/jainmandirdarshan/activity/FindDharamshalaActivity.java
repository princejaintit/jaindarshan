...
import com.jain.temple.jainmandirdarshan.Fragment.DharamshalaInListFragment;
import com.jain.temple.jainmandirdarshan.Fragment.DharmashalaInMapFragment;
...
public class FindDharamshalaActivity extends BaseActivity implements TabLayout.OnTabSelectedListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private FindDharamshalaActivity.Pager adapter;
    ...
    private void inItView() {
        ...
        adapter = new FindDharamshalaActivity.Pager(getSupportFragmentManager(), tabLayout.getTabCount(), title);
        ...
        place_autocomplete_fragment_source.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                if (new UiUtils().isNetworkAvailable(FindDharamshalaActivity.this)) {
                    dialogBoxHelper = new DialogBoxHelper(FindDharamshalaActivity.this);
        ...
        place_autocomplete_fragment_dest.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                Log.i(TAG, "Place: " + place.getName());
                String toastMsg = String.format("Place: %s", place.getName());
                // Toast.makeText(FindDharamshalaActivity.this, toastMsg, Toast.LENGTH_LONG).show();
...
/*
    ...
    private void loadNearByPlaces(String nextPageToken) {
        ...
        String keyword = "Jain Dharamshala";
        ...
        AppController.getInstance().addToRequestQueue(new CustomRequestJson(FindDharamshalaActivity.this, Request.Method.GET,
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            try {
                if (error.networkResponse != null) {
                    ...
                    Toast.makeText(FindDharamshalaActivity.this, jsonObject.getString("error"), Toast.LENGTH_LONG).show();
    ...
    public void addDataonList(JSONArray jsonArray) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (name.contains("jain dharamshala") || name.contains("jain Dharamshala") /*|| name.contains("jain derasar") || name.contains("jain chaityalaya")*/) {
    ...
    private Response.Listener<JSONObject> routeResponse = new Response.Listener<JSONObject>() {
        ...
        public void onResponse(JSONObject response) {
            ...
            FindDharamshalaActivity.ParserTask parserTask = new FindDharamshalaActivity.ParserTask();
    ...
    public void onTabSelected(TabLayout.Tab tab) {
        switch (tab.getPosition()) {
            case 0:
                DharmashalaInMapFragment.newInstance().addMarkerOnMap(mapDataModel);
                break;
            case 1:
                DharamshalaInListFragment.newInstance().showOnList(mapDataModel);
                break;
        }
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            DharmashalaInMapFragment.newInstance().drawPath(mapDataModel);
    ...
    class Pager extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    DharmashalaInMapFragment templeInMapFragment = new DharmashalaInMapFragment().newInstance();
                    Bundle bundle = new Bundle();
                    bundle.putParcelable("data", mapDataModel);
                    templeInMapFragment.setArguments(bundle);
                    return templeInMapFragment;
                case 1:
                    DharamshalaInListFragment templeInListFragment = new DharamshalaInListFragment().newInstance();
