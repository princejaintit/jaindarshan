...
public class DownloadAdaptor extends RecyclerView.Adapter<DownloadAdaptor.DataObjectViewHolder> {
    private ArrayList<AudioModel> audioModelArrayList;
    private FragmentDrawerListener fragmentDrawerListener;

    public DownloadAdaptor(ArrayList<AudioModel> audioModelArrayList, FragmentDrawerListener fragmentDrawerListener) {
    ...
    public DataObjectViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DownloadAdaptor.DataObjectViewHolder(rootView);
    }
